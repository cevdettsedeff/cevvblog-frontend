...
const Footer: React.FC = () => {
  ...
  const loadFooterCategories = async () => {
    try {
      ...
      // Footer için sadece ilk 4 kategoriyi al
      setCategories(Array.isArray(categoriesData) ? categoriesData.slice(0, 4) : []);
    } catch (error) {
      console.error('Footer kategoriler yüklenirken hata:', error);
      setCategories([]);
    }
  };
          ...
          <div>
            ...
            {categories.length > 0 ? (
              <ul className="space-y-2 text-secondary-300">
                ...
                <li>
                  <a href="/categories" className="hover:text-white transition-colors text-primary-400">
                    Tüm kategoriler →
                  </a>
                </li>
              </ul>
              ...
              <ul className="space-y-2 text-secondary-300">
                <li><a href="/categories" className="hover:text-white transition-colors">Kategorileri Keşfet</a></li>
              </ul>
            )}
          </div>
        ...
        <div className="min-h-screen flex flex-col bg-secondary-50">
          ...
          <main className="flex-grow">
            <Routes>
              ...
              <Route path="/category/:slug" element={<div>Kategori Sayfası (Yakında)</div>} />
                    ...
                    <div className="container-custom py-8">
                      ...
                      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <a 
                          ...
                          className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow border border-secondary-200"
                        >
                          <h3 className="text-lg font-semibold text-secondary-900 mb-2">
                            Kategori Yönetimi
                          </h3>
                          <p className="text-secondary-600 text-sm">
                            Kategorileri oluştur, düzenle ve yönet
                          </p>
                        </a>
                        <div className="bg-white p-6 rounded-lg shadow-md border border-secondary-200 opacity-50">
